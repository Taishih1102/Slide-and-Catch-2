...
class Label(pygame.sprite.Sprite):
    ...
    def __init__(self, fontName = "Heyam.ttf"):
        pygame.sprite.Sprite.__init__(self)
...
class Taishi(simpleGE.Sprite):
    def __init__(self, scene):
        super().__init__(scene)   
        self.setImage("Taishi.png")
        self.setSize(50, 70)
        self.minSpeed = 1
        self.maxSpeed = 10

class Sussane(simpleGE.Sprite):
    def __init__(self, scene):
        super().__init__(scene)
        self.setImage("Sussane1.png")
        self.setSize(50, 70)
...
class Game(simpleGE.Scene):
    def __init__(self):
        super().__init__()
        self.setImage("heart1.jpg")
        self.sussane = Sussane(self)
        self.taishi = Taishi(self)
        self.sprites = [self.sussane, self.taishi]
